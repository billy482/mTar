...
static off_t mtar_filter_bzip2_in_position(struct mtar_io_in * io);
...
static struct mtar_io_in_ops mtar_filter_bzip2_in_ops = {
	...
	.position   = mtar_filter_bzip2_in_position,
...
off_t mtar_filter_bzip2_in_position(struct mtar_io_in * io) {
	struct mtar_filter_bzip2_in * self = io->data;
	return self->strm.total_out_lo32;
}
