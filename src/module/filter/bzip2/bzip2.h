...
*  Last modified: Sat, 17 Nov 2012 20:25:28 +0100                           *
\***************************************************************************/
...
struct mtar_io_reader * mtar_filter_bzip2_new_reader(struct mtar_io_reader * io, const struct mtar_option * option, const char * parameters);
